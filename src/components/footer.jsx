...
function footer() {
    return (
        <div data-scroll data-scroll-section data-scroll-speed=""  className='flex pl-[2vw] pr-[3vw] justify-between w-full h-screen bg-zinc-950'>
            <div className='relative pt-[6vw] mb-[2vw]'>
                <div className='uppercase font-semibold text-[6.5vw] leading-[8vw] -tracking-[0.5vw]'>Eye- <br />Opening</div>
            ...
            <div className='relative pt-[3.5vw]'>
                <div className='uppercase font-semibold text-[6.5vw] leading-[8vw] pb-[3vw]'>Presentations</div>
                <div className='flex justify-between pr-[8vw]'>
                    <div>
                        <div className='pb-[1.5vw]'>
                            <p>S:</p>
                            <u className='font-mono text-[1.1vw] leading-none'>Instagram <br />Behance <br />Facebook <br />Linkedin</u>
                        </div>
                        <div className='pb-[1.5vw]'>
                            <p>L:</p>
                            <u className='font-mono text-[1.1vw] leading-none'>202-1965 W 4th Ave <br />
                                Vancouver, Canada <br />
                                <br />
                                30 Chukarina St <br />
                                Lviv, Ukraine</u>
                        ...
                        <div className='pb-[1.5vw]'>
                            <p>E:</p>
                            <u className='font-mono text-[1.1vw] leading-none'>
                                hello@ochi.design
                            </u>
                        </div>
                    </div>
                    <div className='pt-[10vw]'>
                        ...
                        <u className='font-mono text-[1.1vw] leading-none'>Home <br />
                        Services <br />
                        Our work <br />
                        About us <br />
                        Insights <br />
                ...
                <div className='absolute bottom-0 flex gap-[21vw] pb-[1.5vw] text-zinc-700'>
                    <div>© ochi design 2024. <u>Legal Terms</u></div>
