...
function cards({ reference, newCard, index }) {
    return (
        <div className='flex items-center justify-center w-[30vw] h-[32vw] bg-[#212121] rounded-lg overflow-hidden'>
            {index === 0 ? <div className='bg-[#004D43]'><div className='flex justify-center pt-[10.5vw] bg-[#004D43] w-[30vw] h-[30vw]'>
                <svg className='w-[15vw] h-[15vw] text-[#CDEA68]' width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='flex items-center justify-between ml-[1vw] mb-[5vw] w-[10vw] h-[3vw] border-[1px] border-[#CDEA68] rounded-full px-[1vw] '>
                    <span className='flex justify-center items-center w-[1.2vw] h-[1.2vw] border-[1px] border-[#CDEA68] rounded-full'>c</span>
                    2019-2022
                </div>
            </div> :
                <div>
                    <div className='pt-[7vw] flex items-center justify-center w-[30vw] h-[20vw]'>
                        <img className='' src={newCard.image} alt="" />
                    </div>
                    <div className='flex items-center justify-center text-center py-[0.5vw] rounded-full uppercase leading-none w-[16vw] mt-[5vw] ml-[1vw] border-zinc-300 border-[1.7px] hover:bg-zinc-100 hover:text-zinc-900 '>
                        <a href="">
                            {newCard.desc}
                        </a>
                    </div>
